...
-- Insert sample email queue items (for testing the approval flow)
insert into email_queue (id, from_address, subject, body_text, parsed_data, matched_venue_id, status) values
(
  '90909090-9090-9090-9090-909090909090',
  'nublu@nublu.com',
  'This Friday: Free jazz + late night DJs',
  'Hey NowHere team,

This Friday at Nublu we have a special event:

- Free jazz from 8pm-11pm
- Late night DJs starting at 11pm
- No cover all night

Come through!
Nublu team',
  '{
    "title": "Free Jazz + Late Night DJs",
    "description": "Free jazz followed by late night DJ sets",
    "emoji": "🎷",
    "category": "music",
    "tags": ["jazz", "dj", "free"],
    "starts_at": null,
...
(
  ...
  'events@mercurylounge.net',
  'Weekend shows — Sat + Sun lineup',
  'Hello,

Our weekend lineup:

Saturday 8pm: Indie rock showcase - $15
Sunday 7pm: Acoustic night - $10
...
Mercury Lounge',
  '{
    ...
    "description": "Saturday night indie rock showcase",
    "emoji": "🎸",
    "category": "music",
    "tags": ["indie", "rock", "concert"],
    "starts_at": null,
    "ends_at": null,
    "price_label": "$15",
